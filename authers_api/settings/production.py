...
ADMINS = [("ALPHA MALE", "ashrafaaref2020@gmail.com")]

# TODO add domain names of the production server.
CSRF_TRUSTED_ORIGINS = ["https://seer.com"]

SECRET_KEY = env("DJANGO_SECRET_KEY")

ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["seer.com"])
...
SECURE_CONTENT_TYPE_NOSNIFF = env.bool(
    "DJANGO_SECURE_CONTENT_TYPE_NSNIFF", default=True
)
